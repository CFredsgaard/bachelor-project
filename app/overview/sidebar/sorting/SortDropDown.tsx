...
const SortDropDown = (props: {
  ...
  const sortFunctions: SortFunctions = {
    [SortOptions.ALPHABETICALLY]: (a, b) =>
      a.company.name.localeCompare(b.company.name),
    [SortOptions.LOCATION]: (a, b) =>
      a.company.location.localeCompare(b.company.location),
    [SortOptions.MOST_WOMEN_TECH_ROLES]: (a, b) =>
      b.percentageWomenInTechRoles - a.percentageWomenInTechRoles,
    [SortOptions.MOST_WOMEN_LEADERSHIP]: (a, b) =>
      b.percentageWomenInLeadership - a.percentageWomenInLeadership,
    [SortOptions.MOST_MEN_TECH_ROLES]: (a, b) =>
      b.percentageMenInTechRoles - a.percentageMenInTechRoles,
    [SortOptions.MOST_MEN_LEADERSHIP]: (a, b) =>
      b.percentageMenInLeadership - a.percentageMenInLeadership,
    [SortOptions.MOST_FLEXIBLE_DAYS]: (a, b) =>
      b.company.flexibleDays - a.company.flexibleDays,
  };
  ...
  }, [sortBy]); // Re-run the effect when props.companies or sortBy changes
